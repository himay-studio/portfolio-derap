...
// R36/HIM-360 Meta Pixel client. This repo's GTM wiring lives inline in
// src/app/layout.tsx (a server component), so the Meta Pixel client half
// ships as its own client component instead of forcing layout.tsx to become
// one. Mounted in layout.tsx right after the existing GTM noscript block.
//
// Loads the Meta Pixel only when NEXT_PUBLIC_META_PIXEL_ID is set (no-op
// otherwise), fires PageView on every route change, and listens globally for
// WhatsApp/email/phone clicks to fire Lead/Contact.
